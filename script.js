...
function updateAdaptiveLayout() {
    ...
    if (panelRightEdge > playerLeftEdge) {
        ...
        playerScale = availableSpaceForPlayer / playerDefaultWidthPx;
    }
    
    const finalPanelWidthRem = finalPanelWidth / rootFontSize;
    state.activeSheet.style.width = `${Math.max(0, finalPanelWidthRem)}rem`;
